...
namespace DeveloperForest.DAL
{
  public static  class SQLBase
    {
      public static string SQL_GET_Categories = "Select CategoryId,CategoryName,CSSClass,isnull(CurrentIndex,0)as CurrentIndex from MasterCategory order by isnull(CurrentIndex,0) asc";
        public static string SQL_DeleteCategoriesByID = "Delete  from MasterCategory where CategoryId=@CategoryId";
        public static string SQL_GET_SubCategories = "Select SubCategoryID,SubCategoryName,CategoryId,(Select CategoryName from MasterCategory where CategoryId=MasterSubCategory.CategoryId) as CategoryName, isnull(CurrentIndex,0)as CurrentIndex from MasterSubCategory order by isnull(CurrentIndex,0) asc";
        ...
        public static string SQL_GET_Themes = @"Select Themes.ThemeId,(Select CategoryName from MasterCategory where CategoryId= Themes.CategoryId) CategoryName,CategoryId,SubCategoryId,
                                                ...
                                                DownloadLink,(Select imageName from Themeimage where ImageId=Themes.ImageId) as ImageName,RelatedLink1,RelatedLink2,RelatedLink3,RelatedLink4,RelatedLink5 from Themes join AdvancedTheme on 

                                                Themes.ThemeId=AdvancedTheme.ThemeId order by Themes.ThemeId desc ";
        ...
        public static string SQL_Update_SubCategory_Index = "update MasterSubCategory set CurrentIndex=@Index where SubCategoryID=@SubCategoryID";
