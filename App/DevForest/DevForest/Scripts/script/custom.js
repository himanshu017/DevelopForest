...
jQuery(document).ready(function() {
   ...
   $('ul.mainNav li a').each(function () {
       ...
       //alert($(this).attr('href').toUpperCase() + '----' + String(window.location.pathname).toUpperCase());

       if ($(this).attr('href').toUpperCase() == String(window.location.pathname).toUpperCase()) {
           
           $(this).parent().addClass('active');

           if ($(this).parent().parent().hasClass('children')) {
               if ($(this).parent().parent().parent().hasClass('nav-parent')) {
